...
const Index = () => {
    ...
    const quickAccessDynamicDisplay = () => {
        let count = 0;
        if (siteSettings.meetings_mod_enabled) count++;
        if (siteSettings.blog_mod_enabled) count++;
        if (siteSettings.resources_mod_enabled) count++;
        if (siteSettings.events_mod_enabled) count++;
            ...
            >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="mt-10 flex items-center gap-x-6">
                                        {siteSettings.meetings_mod_enabled && (
                                            <Button
                                                size="lg"
                ...
                <section className="relative py-20 bg-gradient-to-b from-gray-50/50 to-white">
                    ...
                    <div className="container mx-auto px-6 lg:px-8 relative">
                        {quickAccessDynamicDisplay() !== 'hidden' && (
                            <motion.div
                        ...
                        <motion.div
                            className={`${cn(quickAccessDynamicDisplay())}`}
                        ...
                        >
                            ...
                            {siteSettings.events_mod_enabled && (
                                <motion.div variants={fadeInUp}>
                                    <Card className="h-full hover:shadow-lg transition-shadow duration-300 border-0 shadow-md">
                                        <CardHeader className="text-center">
                ...
                <section className="relative py-20 bg-gradient-to-b from-gray-50/50 to-gray-100/30">
                    ...
                    <div className="container mx-auto px-6 lg:px-8 relative">
                        ...
                        <motion.div
                            className={cn(siteSettings.blog_mod_enabled ? 'grid-cols-1 md:grid-cols-3' : 'grid-cols-1 md:grid-cols-2', 'grid gap-8')}
                            variants={staggerChildren}
                            initial="initial"
                            whileInView="animate"
                            viewport={{ once: true }}
