...
export function RichTextEditor({ value = "", onChange, placeholder = "", className }: RichTextEditorProps) {
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: cn(
            "block border-input focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive field-sizing-content min-h-64 w-full rounded-md border bg-transparent px-3 py-2 text-base shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
